...
video, contouts, hie = cv2.findContours(b6, cv2.RETR_TREE, cv2.CHAIN_APPROX_NONE)
cnt = contouts
# print(cnt)
for i in cnt:
    # 坐标赋值
...
while cap.isOpened():
    ...
    video, contouts, hie = cv2.findContours(
